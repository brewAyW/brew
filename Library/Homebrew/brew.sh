...
HOMEBREW_DEFALUT_CASKROOM="${HOMEBREW_REPOSITORY}/Caskroom"

HOMEBREW_CASKROOM="${HOMEBREW_CASKROOM:-${HOMEBREW_DEFAULT_CACHE}}"
...
export HOMEBREW_BREW_DEFAULT_GIT_REMOTE="https://github.com/brewayw/brew"
